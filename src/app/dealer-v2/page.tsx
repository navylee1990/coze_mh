    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950">
      <div className="flex h-screen overflow-hidden">
        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="bg-gradient-to-r from-blue-100 to-cyan-100 px-6 py-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6 flex-1">
                {/* 欢迎信息 */}
                <div className="flex items-center gap-3 text-slate-700 text-sm">
                  <span className="font-semibold text-blue-900">你好，{userInfo.name}，{userInfo.company}（{userInfo.companyCode}），今天是您与AO签约的<span className="text-blue-600 font-bold">188</span>天！</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Card className="border-2 border-blue-200 dark:border-blue-800 h-full">
                          <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 py-3">
                            <CardTitle className="text-base flex items-center gap-2">
